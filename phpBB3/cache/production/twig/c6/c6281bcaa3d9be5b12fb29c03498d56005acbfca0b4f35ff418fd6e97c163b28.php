...
";
        ...
        $this->loadTemplate("overall_footer.html", "shop.html", 377)->display($context);
        if ($namespace) {
            $this->env->setNamespaceLookUpOrder($previous_look_up_order);
        }
    }
