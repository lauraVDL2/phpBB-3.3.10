...
";
        ...
        $this->loadTemplate("overall_footer.html", "memberlist_view.html", 369)->display($context);
        if ($namespace) {
            $this->env->setNamespaceLookUpOrder($previous_look_up_order);
        }
    }
