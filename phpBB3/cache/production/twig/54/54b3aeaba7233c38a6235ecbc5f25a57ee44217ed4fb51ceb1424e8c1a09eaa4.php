...
";
        ...
        $this->loadTemplate("overall_footer.html", "fiche_technique.html", 322)->display($context);
        if ($namespace) {
            $this->env->setNamespaceLookUpOrder($previous_look_up_order);
        }
    }
